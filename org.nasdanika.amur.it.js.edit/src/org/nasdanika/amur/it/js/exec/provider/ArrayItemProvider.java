...
/**
 * This is the item provider adapter for a {@link org.nasdanika.amur.it.js.exec.Array} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExecPackage.Literals.ARRAY__ELEMENTS);
		}
	...
	public String getText(Object object) {
		String label = ((Array)object).getJavaScript();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Array.class)) {
			case ExecPackage.ARRAY__ELEMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExecPackage.Literals.ARRAY__ELEMENTS,
