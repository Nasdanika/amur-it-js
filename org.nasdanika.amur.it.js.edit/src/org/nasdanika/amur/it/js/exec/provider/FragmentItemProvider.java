...
/**
 * This is the item provider adapter for a {@link org.nasdanika.amur.it.js.exec.Fragment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FragmentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExecPackage.Literals.FRAGMENT__CODE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Fragment)object).getJavaScript();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Fragment.class)) {
			case ExecPackage.FRAGMENT__CODE:
