...
/**
 * This is the item provider adapter for a {@link org.nasdanika.amur.it.js.foundation.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityItemProvider
	...
	protected void addInputParametersPropertyDescriptor(Object object) {
		ItemPropertyDescriptor ipd = createItemPropertyDescriptor
			(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
			 getResourceLocator(),
			 getString("_UI_Activity_inputParameters_feature"),
			 getString("_UI_PropertyDescriptor_description", "_UI_Activity_inputParameters_feature", "_UI_Activity_type"),
			 FoundationPackage.Literals.ACTIVITY__INPUT_PARAMETERS,
			 true,
			 false,
			 false,
	...
	protected void addHandlerPropertyDescriptor(final Object object) {
		ItemPropertyDescriptor ipd = createItemPropertyDescriptor
			(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
			 getResourceLocator(),
			 getString("_UI_Activity_handler_feature"),
			 getString("_UI_PropertyDescriptor_description", "_UI_Activity_handler_feature", "_UI_Activity_type"),
			 FoundationPackage.Literals.ACTIVITY__HANDLER,
			 true,
			 false,
			 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/script_gear.png"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Activity.class)) {
			case FoundationPackage.ACTIVITY__INPUT_PARAMETERS:
			case FoundationPackage.ACTIVITY__HANDLER:
