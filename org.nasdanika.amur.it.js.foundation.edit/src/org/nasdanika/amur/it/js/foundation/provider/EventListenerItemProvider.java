...
import org.nasdanika.amur.it.js.provider.AbstractEventListenerItemProvider;
...
/**
 * This is the item provider adapter for a {@link org.nasdanika.amur.it.js.foundation.EventListener} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventListenerItemProvider
	extends AbstractEventListenerItemProvider
	implements
	...
	protected void addConditionPropertyDescriptor(final Object object) {
		ItemPropertyDescriptor ipd = createItemPropertyDescriptor
			(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
			 getResourceLocator(),
			 getString("_UI_EventListener_condition_feature"),
			 getString("_UI_PropertyDescriptor_description", "_UI_EventListener_condition_feature", "_UI_EventListener_type"),
			 FoundationPackage.Literals.EVENT_LISTENER__CONDITION,
			 true,
			 false,
			 false,
	...
	protected void addHandlerPropertyDescriptor(final Object object) {
		ItemPropertyDescriptor ipd = createItemPropertyDescriptor
			(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
			 getResourceLocator(),
			 getString("_UI_EventListener_handler_feature"),
			 getString("_UI_PropertyDescriptor_description", "_UI_EventListener_handler_feature", "_UI_EventListener_type"),
			 FoundationPackage.Literals.EVENT_LISTENER__HANDLER,
			 true,
			 false,
			 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ear_listen.png"));
	}
	...
	public String getText(Object object) {
		String label = ((EventListener)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EventListener.class)) {
			case FoundationPackage.EVENT_LISTENER__CONDITION:
			case FoundationPackage.EVENT_LISTENER__HANDLER:
