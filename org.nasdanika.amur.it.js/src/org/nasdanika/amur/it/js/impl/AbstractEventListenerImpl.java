...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Event Listener</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public abstract class AbstractEventListenerImpl extends AbstractNodeImpl implements AbstractEventListener {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected AbstractEventListenerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return JsPackage.Literals.ABSTRACT_EVENT_LISTENER;
	}
	...
	public List<Parameter> genInputParameters(
		...
		return Collections.singletonList(createParameter("event"));
	}
	...
	public DependencyInfo createInputDependencyInfo(
		...
		ret.setRole(DependencyRole.EVENT_SINK);
		ret.setOutputType(OutputType.NEXT_TICK);
		return ret;
	}
		...
		while (cit.hasNext()) {
			...
			if (next instanceof org.nasdanika.amur.it.js.Component) {
				...
				if (parent!=null 
						...
						&& ((AbstractNode) parent.getImplementationType()).collectEventListeners(candidate, context, monitor, status).contains(this) 
					) {
